...
class DatabaseMigrator:
    ...
    def migrate_medical_reference_data(self):
        ...
        try:
            ...
            self.logger.exception(f"Failed to migrate medical reference data: {e}")
            return False
    ...
    def migrate_phi_data(self):
        ...
        try:
            ...
            self.logger.exception(f"Failed to migrate PHI data: {e}")
            return False
    ...
    def update_environment_variables(self):
        ...
        try:
            ...
            self.logger.exception(f"Failed to update environment variables: {e}")
            return False
