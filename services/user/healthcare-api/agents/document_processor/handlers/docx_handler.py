...
class DOCXDocumentHandler(BaseDocumentHandler):
    ...
    async def extract_content(self, file_path: Union[str, Path]) -> str:
        ...
        try:
            ...
            raise DocumentProcessingError(
                f"Failed to extract content from DOCX: {e}",
                str(file_path),
                e
            )
    ...
    async def extract_metadata(self, file_path: Union[str, Path]) -> DocumentMetadata:
        ...
        try:
            ...
            raise DocumentProcessingError(
                f"Failed to extract metadata from DOCX: {e}",
                str(file_path),
                e
            )
    ...
    async def extract_structured_content(self, file_path: Union[str, Path]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            raise DocumentProcessingError(
                f"Failed to extract structured content from DOCX: {e}",
                str(file_path),
                e
            )