...
from core.dependencies import get_database_connection_context
...
class DocumentStorage:
    ...
    async def retrieve_document(self, document_id: str) -> dict[str, Any] | None:
        """
    ...
    async def search_documents(self, query: str, filters: dict[str, Any] | None = None) -> list[dict[str, Any]]:
        """
