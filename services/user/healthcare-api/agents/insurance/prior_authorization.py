...
class PriorAuthorizationAgent:
    ...
    async def process_prior_authorization(
        ...
        try:
            ...
            logger.exception(f"Prior authorization processing failed: {e}")
            return PriorAuthResult(
                status="error",
    ...
    async def check_authorization_status(self, tracking_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Authorization status check failed: {e}")
            return {
                "status": "error",
...
class PriorAuthTracker:
    ...
    async def get_tracking_record(self, tracking_id: str) -> dict[str, Any] | None:
