...
from .config_index import config_cache
...
class OpenWebUIMedicalConfig:
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        ...
        self._medical_terminology: Optional[Dict[str, Any]] = None
        self._phi_config: Optional[Dict[str, Any]] = None
    ...
    def load_medical_context_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error loading Open WebUI medical context config: {e}")
            return self._get_default_config()
    ...
    def load_medical_terminology(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error loading medical terminology config: {e}")
            return self._get_default_terminology()
    ...
    def load_phi_detection_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error loading PHI detection config: {e}")
            return {}
    ...
    def load_healthcare_settings(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error loading healthcare settings: {e}")
            return {}
    ...
    def get_medical_keywords(self, category: Optional[str] = None) -> Dict[str, List[str]] | List[str]:
        """
...
_medical_config_instance: Optional[OpenWebUIMedicalConfig] = None
...
def get_medical_keywords(category: Optional[str] = None) -> Dict[str, List[str]] | List[str]:
    """Get medical keywords for topic extraction"""
