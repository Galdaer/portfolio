...
async def demo_voice_intake_workflow():
    ...
    print(f"Voice Intake Configuration:")
    ...
    try:
        ...
        print(f"✅ Voice workflow started!")
        print(f"Workflow ID: {workflow_id}")
...
async def demo_workflow_step_processing():
    ...
    try:
        ...
        print(f"✅ Standard workflow step completed:")
    ...
    try:
        ...
        print(f"✅ Voice workflow step completed:")
