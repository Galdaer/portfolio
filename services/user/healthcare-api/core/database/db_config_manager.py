...
class DatabaseConfigManager:
    ...
    async def check_databases_exist(self) -> dict[str, bool]:
        ...
        try:
            ...
            self.logger.exception(f"Failed to check databases: {e}")
            raise
    ...
    async def create_databases(self):
        ...
        try:
            ...
            self.logger.exception(f"Failed to create databases: {e}")
            raise
    ...
    async def _create_database(
        ...
        try:
            ...
            self.logger.exception(f"Failed to create database {db_name}: {e}")
            raise
    ...
    async def apply_schemas(self):
        ...
        try:
            ...
            self.logger.exception(f"Failed to apply schemas: {e}")
            raise
    ...
    async def _apply_schema(
        ...
        try:
            ...
            self.logger.exception(f"Failed to apply schema {schema_file}: {e}")
            raise
    ...
    async def check_tables_exist(self) -> dict[str, dict[str, bool]]:
        ...
        try:
            ...
            self.logger.exception(f"Failed to check tables: {e}")
            raise
    ...
    async def run_migrations(self, migration_dir: str = None):
        ...
        try:
            ...
            self.logger.exception(f"Failed to run migrations: {e}")
            raise
