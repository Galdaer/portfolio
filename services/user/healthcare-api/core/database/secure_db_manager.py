...
class SecureDatabaseManager:
    ...
    def __init__(self, config_path: str = None):
        ...
        # Connection pools
        self.public_pool: Optional[asyncpg.Pool] = None
        self.private_pool: Optional[asyncpg.Pool] = None
    ...
    async def _audit_query(
        ...
        try:
            ...
            self.logger.error(f"Failed to audit query: {e}")
    ...
    async def transaction(
        ...
        if not pool:
            raise RuntimeError(f"{database.value} database pool not initialized")
...
# Singleton instance
_db_manager: Optional[SecureDatabaseManager] = None
