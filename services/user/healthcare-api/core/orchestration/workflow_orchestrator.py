...
class WorkflowOrchestrator:
    ...
    async def _execute_workflow_step(
        ...
        if not agent:
            raise RuntimeError(f"Agent not registered for specialization: {step.agent_specialization.value}")
        ...
        try:
            ...
            raise RuntimeError(f"Step {step.step_name} timed out after {step.timeout_seconds} seconds")
    ...
    def _compile_workflow_result(self, workflow_execution: WorkflowExecution) -> Dict[str, Any]:
        ...
        elif workflow_execution.workflow_type == WorkflowType.VOICE_INTAKE_WORKFLOW:
            return {
        ...
        elif workflow_execution.workflow_type == WorkflowType.CLINICAL_DECISION:
            return {
        ...
        elif workflow_execution.workflow_type == WorkflowType.COMPREHENSIVE_ANALYSIS:
            return {
