...
class ConfigurationFileHandler(FileSystemEventHandler):
    ...
    def reload_configuration(self, file_path: Path):
        ...
        try:
            ...
            logger.error(f"Failed to hot-reload configuration {file_path}: {e}")
...
class HotReloadService:
    ...
    async def initialize(self, config_directory: str | Path):
        ...
        try:
            ...
            logger.error(f"Failed to initialize hot-reload service: {e}")
            raise
    ...
    async def register_default_handlers(self):
        ...
        def reload_ui_config():
            try:
                ...
                logger.error(f"Failed to reload UI configuration: {e}")
        ...
        def reload_transcription_config():
            try:
                ...
                logger.error(f"Failed to reload transcription configuration: {e}")
        ...
        def reload_medical_search_config():
            try:
                ...
                logger.error(f"Failed to reload medical search configuration: {e}")
    ...
    async def shutdown(self):
        ...
        try:
            ...
            logger.error(f"Error during hot-reload service shutdown: {e}")
