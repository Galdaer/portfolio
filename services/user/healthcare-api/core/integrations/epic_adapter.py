...
class EpicMyChartAdapter:
    ...
    async def authenticate(self):
        ...
        try:
            ...
            self.logger.error(f"Epic authentication failed: {e}")
            raise
    ...
    async def search_slots(
        ...
        try:
            ...
            self.logger.error(f"Failed to search slots: {e}")
            raise
    ...
    async def _store_appointment_locally(
        ...
        try:
            ...
            self.logger.error(f"Failed to store appointment locally: {e}")
    ...
    async def get_practitioner_schedule(
        ...
        try:
            ...
            self.logger.error(f"Failed to get practitioner schedule: {e}")
            raise
    ...
    async def sync_appointments(
        ...
        try:
            ...
            self.logger.error(f"Failed to sync appointments: {e}")
            raise
