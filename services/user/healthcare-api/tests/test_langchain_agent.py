...
class TestHealthcareLangChainAgent:
    ...
    async def test_mcp_client_connectivity(self):
        ...
        try:
            ...
            assert any('patient' in str(tool).lower() for tool in tools), "Should have patient-related tools"
    ...
    async def test_ollama_connectivity(self):
        ...
        try:
            ...
            response = await self.agent.process("Hello, can you tell me about medical search capabilities?")
