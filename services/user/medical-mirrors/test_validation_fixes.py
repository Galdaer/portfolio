...
from src.validation_utils import DataValidator, validate_record
...
def test_database_validation():
    ...
    try:
        ...
        logger.error(f"PubMed validation failed: {e}")
    ...
    try:
        ...
        logger.error(f"Clinical Trial validation failed: {e}")
    ...
    try:
        ...
        logger.error(f"FDA Drug validation failed: {e}")
...
def test_length_validation():
    ...
    logger.info(f"Length validation:")
