...
class BillingCodesBackgroundService:
    ...
    def __init__(self, config: Config | None = None):
        ...
        self.downloader: SmartBillingCodesDownloader | None = None
    ...
    def _load_service_state(self):
        ...
        try:
            ...
            logger.exception(f"Error loading service state: {e}")
    ...
    def _save_service_state(self):
        ...
        try:
            ...
            logger.exception(f"Error saving service state: {e}")
    ...
    async def _service_loop(self):
        ...
        while not self.shutdown_requested:
            try:
                ...
                logger.exception(f"Error in service loop iteration: {e}")
    ...
    async def _check_for_retries(self):
        ...
        try:
            ...
            logger.exception(f"Error checking for retries: {e}")
    ...
    async def _run_download_session(self, session_type: str):
        ...
        try:
            ...
            logger.exception(f"Download session timed out after {self.max_download_duration} seconds")
        except Exception as e:
            logger.exception(f"Error in {session_type} download session: {e}")
    ...
    async def _save_session_report(self, session_type: str, summary: dict[str, Any],
        ...
        try:
            ...
            logger.exception(f"Error saving session report: {e}")
    ...
    def _calculate_sleep_time(self) -> int:
        ...
        if hasattr(self, "downloader") and self.downloader:
            try:
                ...
                loop.create_task(self.downloader.get_download_status())
    ...
    async def _shutdown_service(self):
        ...
        if self.downloader:
            try:
                ...
                logger.exception(f"Error closing downloader: {e}")
