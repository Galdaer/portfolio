...
class CMSHCPCSDownloader:
    ...
    def __init__(self, state_manager: Optional[DownloadStateManager] = None, 
    ...
    def _parse_hcpcs_zip(self, zip_content: bytes, source: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Invalid ZIP file for {source}")
        except Exception as e:
            logger.error(f"Error parsing ZIP file for {source}: {e}")
    ...
    def _extract_hcpcs_fields(self, row: Dict[str, str]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error extracting HCPCS fields: {e}")
            return None
    ...
    async def _save_codes_to_file(self, codes: List[Dict[str, Any]], output_file: Path):
        ...
        try:
            ...
            logger.error(f"Error saving codes to {output_file}: {e}")
