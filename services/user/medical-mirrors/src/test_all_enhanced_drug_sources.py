...
async def test_all_enhanced_drug_sources():
    ...
    try:
        ...
        logger.exception(f"❌ DailyMed test failed: {e}")
    ...
    try:
        ...
        logger.exception(f"❌ ClinicalTrials test failed: {e}")
    ...
    try:
        ...
        logger.exception(f"❌ OpenFDA FAERS test failed: {e}")
    ...
    try:
        ...
        logger.exception(f"❌ RxClass test failed: {e}")
    ...
    try:
        ...
        logger.exception(f"❌ DrugCentral test failed: {e}")
    ...
    try:
        ...
        logger.exception(f"❌ DDInter test failed: {e}")
    ...
    try:
        ...
        logger.exception(f"❌ LactMed test failed: {e}")
