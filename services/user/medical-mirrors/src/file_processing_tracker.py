...
class FileProcessingTracker:
    ...
    def calculate_file_hash(self, file_path: str) -> str:
        ...
        try:
            ...
            self.logger.exception(f"Failed to calculate hash for {file_path}: {e}")
            return ""
    ...
    def is_file_already_processed(self, file_path: str, source_type: str) -> ProcessedFile | None:
        ...
        try:
            ...
            self.logger.exception(f"Error checking processed file {file_path}: {e}")
            return None
    ...
    def mark_file_processed(
        ...
        try:
            ...
            self.logger.exception(f"Failed to mark file processed {file_path}: {e}")
    ...
    def get_processing_stats(self, source_type: str | None = None) -> dict[str, int]:
        ...
        try:
            ...
            self.logger.exception(f"Failed to get processing stats: {e}")
            return {
                "total_files": 0,
    ...
    def cleanup_old_records(self, days_old: int = 30) -> int:
        ...
        try:
            ...
            self.logger.exception(f"Failed to cleanup old records: {e}")
            self.db_session.rollback()
            return 0

    def reset_processing_status(self, source_type: str | None = None, file_name: str | None = None) -> int:
        ...
        try:
            ...
            self.logger.exception(f"Failed to reset processing status: {e}")
            self.db_session.rollback()
            return 0
