...
class DataValidator:
    ...
    def validate_required_field(cls, value: Any, field_name: str, table_name: str) -> Any:
        ...
        if value is None or (isinstance(value, str) and not value.strip()):
            raise ValidationError(f"Required field {table_name}.{field_name} is empty")
        return value
    ...
    @classmethod
    def validate_doi(cls, doi: str) -> Optional[str]:
        """Validate DOI format"""
        if not doi:
            return None
    ...
    @classmethod
    def validate_pmid(cls, pmid: str) -> Optional[str]:
    ...
    @classmethod
    def validate_nct_id(cls, nct_id: str) -> Optional[str]:
    ...
    @classmethod
    def validate_ndc(cls, ndc: str) -> Optional[str]:
    ...
    @classmethod
    def validate_icd10_code(cls, code: str) -> Optional[str]:
    ...
    @classmethod
    def validate_date_string(cls, date_value: Any) -> Optional[str]:
