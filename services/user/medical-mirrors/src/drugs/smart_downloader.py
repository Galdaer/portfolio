...
class SmartDrugDownloader:
    ...
    async def download_all_drug_data(self, force_fresh: bool = False, complete_dataset: bool = True, sources: list[str] | None = None) -> dict[str, Any]:
        """
        ...
        try:
            ...
            logger.exception(f"Unified drug download failed: {e}")
