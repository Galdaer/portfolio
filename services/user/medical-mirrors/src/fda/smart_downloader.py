...
from drugs.downloader import DrugDownloader
...
class SmartFDADownloader:
    """Smart downloader for FDA drug data sources with state management"""
    ...
    def _load_state(self) -> Dict[str, Any]:
        ...
        state_file = self.output_dir / "fda_download_state.json"
    ...
    async def download_all(self, force_fresh: bool = False, complete_dataset: bool = True) -> Dict[str, Any]:
        """
        ...
        if not force_fresh:
            ...
            if saved_state:
                logger.info(f"Loaded previous state: {len(saved_state.get('completed_datasets', []))} datasets completed")
        ...
        try:
            ...
            # Update state - track by datasets downloaded
