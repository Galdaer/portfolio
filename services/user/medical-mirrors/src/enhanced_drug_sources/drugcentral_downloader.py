...
class SmartDrugCentralDownloader:
    ...
    async def _connect_database(self):
        ...
        try:
            ...
            logger.exception(f"Failed to connect to DrugCentral database: {e}")
    ...
    def _save_state(self):
        ...
        try:
            ...
            logger.exception(f"Failed to save DrugCentral state: {e}")
    ...
    async def download_mechanism_of_action_data(self) -> str | None:
        ...
        try:
            ...
            logger.exception(f"Error downloading mechanism of action data: {e}")
            self.state.failed_downloads += 1
            return None

    async def download_drug_target_data(self) -> str | None:
        ...
        try:
            ...
            logger.exception(f"Error downloading drug target data: {e}")
            self.state.failed_downloads += 1
            return None

    async def download_pharmacology_data(self) -> str | None:
        ...
        try:
            ...
            logger.exception(f"Error downloading pharmacology data: {e}")
            self.state.failed_downloads += 1
            return None
