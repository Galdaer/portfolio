...
class ICD10DownloadStateManager:
    ...
    def _load_state(self):
        ...
        try:
            ...
            logger.exception(f"Failed to load ICD-10 download state: {e}")
            self._states = {}
    ...
    def _save_state(self):
        ...
        try:
            ...
            logger.exception(f"Failed to save ICD-10 download state: {e}")
    ...
    def update_state(self, source: str, **kwargs) -> DownloadState:
        ...
        if source not in self._states:
            msg = f"No state found for ICD-10 source: {source}"
