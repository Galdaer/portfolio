...
class ICD10BackgroundService:
    ...
    def __init__(self, config: Optional[Config] = None):
        ...
        self.downloader: Optional[SmartICD10Downloader] = None
    ...
    def _load_service_state(self):
        ...
        try:
            ...
            logger.error(f"Error loading ICD-10 service state: {e}")
    ...
    def _save_service_state(self):
        ...
        try:
            ...
            logger.error(f"Error saving ICD-10 service state: {e}")
    ...
    async def start_service(self):
        ...
        try:
            ...
            logger.error(f"Error in ICD-10 service main loop: {e}")
        finally:
    ...
    async def _service_loop(self):
        ...
        while not self.shutdown_requested:
            try:
                ...
                logger.error(f"Error in ICD-10 service loop iteration: {e}")
    ...
    async def _check_for_retries(self):
        ...
        try:
            ...
            if ready_sources:
                ...
                if current_total > self.stats["largest_successful_download"]:
                    self.stats["largest_successful_download"] = current_total
                
        except Exception as e:
            logger.error(f"Error checking for ICD-10 retries: {e}")
    ...
    async def _run_download_session(self, session_type: str):
        ...
        try:
            ...
            logger.error(f"ICD-10 download session timed out after {self.max_download_duration} seconds")
        except Exception as e:
            logger.error(f"Error in {session_type} ICD-10 download session: {e}")
    ...
    async def _save_session_report(self, session_type: str, summary: Dict[str, Any], 
        ...
        try:
            ...
            logger.error(f"Error saving ICD-10 session report: {e}")
    ...
    async def _shutdown_service(self):
        ...
        if self.downloader:
            try:
                ...
                logger.error(f"Error closing ICD-10 downloader: {e}")
    ...
    async def trigger_immediate_download(self, force_fresh: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error in manual ICD-10 download: {e}")
            raise
...
async def run_service():
    ...
    try:
        ...
        logger.error(f"ICD-10 service error: {e}")
        sys.exit(1)
