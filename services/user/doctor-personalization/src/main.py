...
class DoctorPersonalizationService:
    ...
    def setup_routes(self):
        ...
        async def get_personalization_analytics(
            ...
            try:
                ...
                return await self.generate_personalization_analytics(
        ...
        async def get_model_performance(
            ...
            try:
                ...
                return await self.calculate_model_performance(
                    doctor_id, start_date, end_date,
                )
    ...
    async def evaluate_rule_conditions(
        ...
        return not ("task_type" in conditions and request.task_type not in conditions["task_type"])
    ...
    async def adapt_for_concise_style(self, content: str) -> str:
        ...
        if len(content) > 300:  # If response is long, summarize
            ...
            return await self.get_base_response(
...
"""
    ...
    async def store_doctor_profile(self, profile: DoctorProfile):
        ...
        async with self.db_pool.acquire() as conn:
            ...
            """,
                ...
                json.dumps(list(profile.interaction_history)),
    ...
    async def get_doctor_profile(self, doctor_id: str) -> DoctorProfile | None:
    ...
    async def calculate_model_performance(
        self, doctor_id: str | None, start_date: datetime, end_date: datetime,
    ) -> dict[str, Any]:
