    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if "choices" in response_data and len(response_data["choices"]) > 0:
                ...
                has_medical_content = any(keyword in response_content.lower() for keyword in medical_keywords)
            ...
            if "ToolRegistry" in error_content or "MCP" in error_content:
                print("✅ Infrastructure integration is working (ToolRegistry/MCP detected in error)")
                return True
            else:
...
def main():
    ...
    tests = [
        ...
        ("OpenAI Endpoint Integration", endpoint_ok)
    ]
