    ...
    def generate_synthetic_patient(self) -> SyntheticPatient:
        ...
        for _ in range(num_conditions):
            condition = {
                ...
                "diagnosed_date": self.fake.date_between(start_date='-10y', end_date='today').isoformat(),
        ...
        for _ in range(num_medications):
            medication = {
                ...
                "frequency": self.fake.random_element(['Once daily', 'Twice daily', 'Three times daily', 'As needed']),
...
if __name__ == "__main__":
    ...
    generator.save_dataset(dataset, "/opt/intelluxe/data/evaluation/synthetic/healthcare_test_data.json")
