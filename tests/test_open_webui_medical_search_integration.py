...
class TestOpenWebUIMedicalSearchIntegration:
    ...
    def test_medical_search_agent_formatting(self):
        ...
        try:
            ...
            assert '2023-06-15' in formatted_response or '2024-01-10' in formatted_response, "Publication dates missing"
            assert 'Smith J, Johnson A, Brown K et al.' in formatted_response, "Author truncation not working"
    ...
    def test_metadata_completeness(self):
        ...
        for i, source in enumerate(self.mock_sources, 1):
            ...
            assert source.get('publication_date') or source.get('date'), f"Article {i} missing publication date"
