...
def print_status_report(status):
    ...
    for table, description in tables:
        ...
        # Determine status
        if table == "pubmed_articles" and count >= 400000 or table == "clinical_trials" and count >= 200000 or table == "drug_information" and count >= 20000 or table == "icd10_codes" and count >= 40000 or table == "billing_codes" and count >= 8000 or table in ["health_topics", "food_items", "exercises"] and count > 0:
            icon = "✅"
        elif count > 0:
            icon = "⚠️"
        else:
