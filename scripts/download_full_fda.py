...
class CompleteFDADownloader:
    ...
    async def download_complete_archive(self) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.info("✅ Complete FDA download finished!")
    ...
    async def download_orange_book(self) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.exception(f"❌ Orange Book download failed: {e}")
    ...
    async def download_ndc_directory(self) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.exception(f"❌ NDC Directory download failed: {e}")
    ...
    async def download_drugs_fda(self) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.exception(f"❌ Drugs@FDA download failed: {e}")
        ...
        try:
            ...
            for i, partition in enumerate(label_partitions, 1):
                try:
                    ...
                    self.logger.exception(f"❌ Failed to download partition {i}: {e}")
            ...
            self.logger.exception(f"❌ Drug labels download failed: {e}")
...
def main():
    ...
    # Show next steps
    print("\n📋 Next Steps:")
    print("   1. Parse downloaded files: python scripts/parse_downloaded_archives.py fda")
    print("   2. Or use medical-mirrors API: POST /update/fda")
