...
from deduplication_engine import CrossBatchDeduplicator, DeduplicationProgressTracker
...
async def test_within_batch_deduplication():
    ...
    with get_db_session() as db:
        ...
        logger.info("✅ Within-batch deduplication results:")
...
async def test_content_based_deduplication():
    ...
    with get_db_session() as db:
        ...
        logger.info("✅ Content-based deduplication results:")
...
async def test_cross_batch_filtering():
    ...
    with get_db_session() as db:
        ...
        logger.info("✅ Cross-batch filtering results:")
        logger.info(f"   Input records: {len(test_trials)}")
...
async def test_progress_tracking():
    ...
    with get_db_session() as db:
        ...
        logger.info("✅ Progress tracking results:")
...
async def run_comprehensive_test():
    ...
    try:
        ...
        logger.info("✅ Overall Deduplication Performance:")
        ...
        logger.info("   ✓ 99%+ duplicate elimination within batches")
        logger.info("   ✓ Content-based duplicate detection across different IDs")
        logger.info("   ✓ Cross-batch filtering prevents reprocessing")
        logger.info("   ✓ Accurate progress tracking despite massive duplication")
        logger.info("   ✓ Significant performance improvements over naive processing")
