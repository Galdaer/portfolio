...
class HealthcareComplianceConfig(BaseModel):
    ...
    max_failed_auth_attempts: int = Field(default=3, description="Max failed authentication attempts")
...
class CacheConfig(BaseModel):
    ...
    medical_literature_ttl_hours: int = Field(default=24, description="Medical literature cache TTL")
...
class DatabaseConfig(BaseModel):
    ...
    postgres_url: str = Field(default="postgresql://localhost:5432/intelluxe", description="PostgreSQL URL")
...
class MonitoringConfig(BaseModel):
    ...
    alert_threshold_response_time_ms: int = Field(default=5000, description="Response time alert threshold")
