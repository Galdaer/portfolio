...
class InsuranceVerificationAgent(BaseHealthcareAgent):
    ...
    async def verify_insurance_eligibility(self, insurance_info: Dict[str, Any]) -> InsuranceVerificationResult:
        """
        ...
        try:
            ...
            if coverage_active:
                ...
                benefits_summary = {
                    ...
                    "termination_date": benefits.termination_date.isoformat() if benefits.termination_date else None
                }
    ...
    async def _check_eligibility(self, insurance_info: Dict[str, Any], payer_name: str) -> Dict[str, Any]:
        """
    ...
    async def _get_benefits_details(self, insurance_info: Dict[str, Any], payer_name: str) -> BenefitsDetails:
        """
    ...
    async def request_prior_authorization(self, auth_request: Dict[str, Any]) -> PriorAuthResult:
        ...
        try:
            # Validate required fields
            required_fields = ['member_id', 'procedure_codes', 'diagnosis_codes', 'provider_id', 'service_date']
            for field in required_fields:
            ...
            if is_approved:
                ...
                status = "denied"
                estimated_days = 0
                auth_errors.append("Prior authorization denied - insufficient medical necessity documentation")
    ...
    async def check_coverage_for_service(self, coverage_request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        coverage_info = coverage_rules.get(service_code, {
            "covered": False,
            "copay": 0.00,
            "coinsurance": 0.0,
            "prior_auth": False
        ...
        result = {
            ...
            "patient_cost": {
                ...
                "estimated_patient_cost": coverage_info["copay"] + (100.00 * coverage_info["coinsurance"])
            },
