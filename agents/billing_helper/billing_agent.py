...
class BillingHelperAgent(BaseHealthcareAgent):
    ...
    async def validate_cpt_code(self, cpt_code: str) -> CPTCodeValidation:
        ...
        if clean_code in cpt_database:
            ...
            return CPTCodeValidation(
                ...
                modifier_required=code_info["modifier_required"],
                billing_notes=code_info["billing_notes"]
            )
        else:
            return CPTCodeValidation(
                code=clean_code,
    ...
    def _calculate_claim_amount(self, claim_data: Dict[str, Any], cpt_validations: List[CPTCodeValidation]) -> float:
        """
    ...
    async def verify_insurance_benefits(self, insurance_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        sanitized_info = sanitize_healthcare_data(insurance_info)
