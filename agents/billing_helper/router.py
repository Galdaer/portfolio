...
async def validate_cpt_code(cpt_code: str) -> dict[str, Any]:
    ...
    try:
        log_healthcare_event(
            ...
            context={"endpoint": "/billing/validate-cpt", "cpt_code": cpt_code},
        ...
        log_healthcare_event(
            ...
            context={"endpoint": "/billing/validate-cpt", "cpt_code": cpt_code, "error": str(e)},
            operation_type="api_error",
        )
...
async def validate_icd_code(icd_code: str) -> dict[str, Any]:
    ...
    try:
        log_healthcare_event(
            ...
            context={"endpoint": "/billing/validate-icd", "icd_code": icd_code},
            operation_type="code_validation",
        )
        ...
        log_healthcare_event(
            ...
            context={"endpoint": "/billing/validate-icd", "icd_code": icd_code, "error": str(e)},
            operation_type="api_error",
        )
...
async def generate_billing_report(start_date: str, end_date: str) -> dict[str, Any]:
    ...
    try:
        log_healthcare_event(
            ...
            context={"endpoint": "/billing/report", "start_date": start_date, "end_date": end_date},
