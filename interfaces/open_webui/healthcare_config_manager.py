...
from config.transcription_config_loader import (
    TRANSCRIPTION_CONFIG,
    reload_transcription_config,
    update_transcription_config_yaml,
)
from config.ui_config_loader import UI_CONFIG, reload_ui_config, update_ui_config_yaml
...
class Action:
    ...
    async def action(
        ...
        try:
            ...
            self.logger.exception(f"Configuration manager error: {e}")
            return {
                "success": False,
